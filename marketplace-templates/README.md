...
| **`ohrt-futureDriveTime.yaml`** | **Future Drive Time**: Uses the Google Maps API to calculate the future drive times and distances between two addresses or points with a desired arrival time. | [Driving Time and Distance using Google Maps [5.2.0.0,5.9.9.9]](https://community.openhab.org/t/driving-time-and-distance-using-google-maps-5-2-0-0-5-9-9-9/170195) |
